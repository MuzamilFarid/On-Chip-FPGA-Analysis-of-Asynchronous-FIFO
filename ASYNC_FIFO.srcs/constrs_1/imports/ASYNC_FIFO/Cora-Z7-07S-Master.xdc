...
# Read Clock
#set_property -dict { PACKAGE_PIN F17   IOSTANDARD LVCMOS33 } [get_ports { rd_clk }];
#create_clock -period 20.000 -name rd_clk_pin -waveform {0.000 10.000} -add [get_ports rd_clk]

#Write side constraints
#set_property -dict { PACKAGE_PIN J19   IOSTANDARD LVCMOS33 } [get_ports { wr_rstn }]; 
#set_property -dict { PACKAGE_PIN K17   IOSTANDARD LVCMOS33 } [get_ports { wr_en }]; 
#set_property -dict { PACKAGE_PIN L16   IOSTANDARD LVCMOS33 } [get_ports { wr_data }]; 

#Read Side Interface
#set_property -dict { PACKAGE_PIN N16   IOSTANDARD LVCMOS33 } [get_ports { rd_rstn }]; 
#set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33 } [get_ports { rd_en }];
#set_property -dict {PACKAGE_PIN U14 IOSTANDARD LVCMOS33 }     [get_ports {rd_data}];

#Full and empty 

set_property -dict {PACKAGE_PIN V13 IOSTANDARD LVCMOS33} [get_ports {full}];
set_property -dict {PACKAGE_PIN T14 IOSTANDARD LVCMOS33} [get_ports {empty}];

#Declare the clocks as Asynchronous
set_clock_groups -quiet -asynchronous -group [get_clocks clk_out1_clk_wiz_0] -group [get_clocks clk_out2_clk_wiz_0]
set_clock_groups -quiet -asynchronous -group [get_clocks clk_out2_clk_wiz_0] -group [get_clocks sys_clk_pin]
set_clock_groups -quiet -asynchronous -group [get_clocks clk_out1_clk_wiz_0] -group [get_clocks sys_clk_pin]


## Add further timing constraints for asynchronous nature between the write and read clocks

#set_clock_groups -asynchronous -group clk_dm_1_clk_wiz_0 -group clk_dm_2_clk_wiz_0
#set_clock_groups -asynchronous -group clk_dm_1_clk_wiz_0 -group clk_dm_2_clk_wiz_0_1
#set_clock_groups -asynchronous -group clk_dm_1_clk_wiz_0 -group clk_dm_1_clk_wiz_0_1
#set_clock_groups -asynchronous -group clk_dm_1_clk_wiz_0_1 -group clk_dm_1_clk_wiz_0_1
#set_clock_groups -asynchronous -group clk_dm_1_clk_wiz_0_1 -group clk_dm_2_clk_wiz_0
#set_clock_groups -asynchronous -group clk_dm_1_clk_wiz_0_1 -group clk_dm_2_clk_wiz_0_1
#set_clock_groups -asynchronous -group clk_dm_2_clk_wiz_0 -group clk_dm_2_clk_wiz_0_1
...
#set_property -dict {PACKAGE_PIN U14 IOSTANDARD LVCMOS33} [get_ports {o_dest_data[0]}]
#set_property -dict {PACKAGE_PIN V13 IOSTANDARD LVCMOS33} [get_ports {o_dest_data[1]}]
#set_property -dict {PACKAGE_PIN T14 IOSTANDARD LVCMOS33} [get_ports {o_dest_data[2]}]
#set_property -dict {PACKAGE_PIN T15 IOSTANDARD LVCMOS33} [get_ports {o_dest_data[3]}]
#set_property -dict {PACKAGE_PIN V17 IOSTANDARD LVCMOS33} [get_ports o_valid_data]
#set_property -dict {PACKAGE_PIN V18 IOSTANDARD LVCMOS33} [get_ports o_busy]
